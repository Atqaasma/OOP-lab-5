...
int main() {
    ...
    library.addBook(Book("Where the Crawdads Sing", "Delia Owens", 2018));
    library.addBook(Book("The Silent Patient", "Alex Michaelides", 2019));
    library.addBook(Book("Such a Fun Age", "Kiley Reid", 2019));
    ...
    library.searchBook("TThe Silent Patient");

    // Removing a book
    library.removeBook("Such a Fun Age");
    cout << "\nAfter removing 'Such a Fun Age':" << endl;
    library.listBooks();
